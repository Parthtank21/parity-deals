...
export function getViewsByPPPChartData({
  ...
  const cachedFn = dbCache(getViewsByPPPChartDataInternal, {
    tags: [
...
export function getViewsByCountryChartData({
  ...
  const cachedFn = dbCache(getViewsByCountryChartDataInternal, {
    tags: [
      getUserTag(userId, CACHE_TAGS.productViews),
      productId == null
        ? getUserTag(userId, CACHE_TAGS.products)
...
export function getViewsByDayChartData({
  ...
  const cachedFn = dbCache(getViewsByDayChartDataInternal, {
    tags: [
      getUserTag(userId, CACHE_TAGS.productViews),
      productId == null
        ? getUserTag(userId, CACHE_TAGS.products)
